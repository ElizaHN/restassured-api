...
public class consultaBookingDefinition {
    ...
    public void validarValoresDeLaRespuestaDeBooking(DataTable booking) {
        ...
        for (int i=0; i<data.size(); i++){
            ...
            Assert.assertEquals(data.get(i).get("fecinicio"), json.getString("bookingdates.checkin"));
            Assert.assertEquals(data.get(i).get("fecfin"), json.getString("bookingdates.checkout"));
        }
